...
export function setupClipboardListeners() {
  return (dispatch, getState) => {
    ...
    const listeners = {
      'storer/execute_task': e => dispatch(listenStorerExecuteTask(e)),
  ...
  // clipboard listenStorerExecuteTask: {"args": ["018868cf-7e57-44b0-a8d0-c8d73c5ba133", "copyMetadata"], "component": "storer", "type": "execute_task"}
 ...
 /* clipboard listenStorerChangeMode: {"args": ["018868cf-7e57-44b0-a8d0-c8d73c5ba133", "storeTask"], "component": "storer", "type": "change_mode"}
  * clipboard listenStorerChangeMode: {"args": ["018868cf-7e57-44b0-a8d0-c8d73c5ba133", "store"], "component": "storer", "type": "change_mode"}
  */
